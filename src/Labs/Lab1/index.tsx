{/* 2.3 Creating the Labs Components */ }
  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <h5>Ordered List Tag</h5>
        {/* My recipe*/}
        My favorite recipe (Meat Loaf):
        <ol id="wd-your-favorite-recipe">
          <li>1 lb ground beef (or a mix of beef and pork).</li>
          ...
          <li>1 tsp salt.</li>
          <li>1/4 cup ketchup (for topping).</li>
          <li>Serve and enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          ...
          <li>The pigeon steals a hot dog</li>
        </ul>
      </div>
      {/*2.9 Table Tags*/}
      <div id="wd-tables">
        <h4>Table Tag (Example)</h4>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input type="number" id="wd-text-fields-age" placeholder="Age" title="The Age" /> <br />

          <label htmlFor="wd-text-fields-school-name">School Name:</label>
          <input type="text" id="wd-text-fields-school-name" placeholder="School Name" value="Wonder School" title="School Name" />
        ...
        <h4>Anchor tag</h4>
        Please <a id="wd-github" href="https://github.com/jannunzi/kanbas-react-web-app.git
">click here </a>
        to get dummy text<br />
